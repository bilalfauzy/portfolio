...
const experiences = [
  ...
  },
  {
    ...
    period: "6 Bulan",
    tags: ["WMS", "RFID", "Laravel"],
    desc: "Membangun aplikasi Warehouse Management System (WMS) berbasis web menggunakan Laravel, JavaScript, dan MySQL. Mengembangkan juga aplikasi RFID berbasis Java untuk tracking barang di gudang secara real-time.",
    highlights: [
      "Develop WMS (Warehouse Management System) dengan Laravel & MySQL",
      "Fitur manajemen stok, inbound/outbound, dan laporan gudang",
      "Membangun aplikasi RFID berbasis Java untuk tracking barang real-time",
      "Desain dan implementasi REST API",
      "Pengelolaan dan optimasi database MySQL",
    ],
  },
  {
